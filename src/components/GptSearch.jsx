...
const GptSearch = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-700 to-red-700 absolute  top-0   -z-10 w-full">
      <div className="flex justify-center mt-20 ">
        <form className="bg-black p-4 rounded mt-10" onSubmit={handleForm}>
          <input
          ...
          />
          <button className="px-2 bg-red-500 rounded mx-1 h-10  focus:bg-red-700">
            {lang[langKey].search}
          </button>
        </form>
      </div>
